...
## Setup
A heartbeat-enabled three-validator shard with ten sequential finalized deploy blocks and a transient readonly observer configured with a short network timeout.
